...
- [ ] A diretiva CONST deve aceitar numeros positivos (inteiros e hexadecimal) e negativos (inteiros).
...
- [ ] O comando COPY deve utilizar uma virgula e um espaco entre os operandos (COPY A, B).
